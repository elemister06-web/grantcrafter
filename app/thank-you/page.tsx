...
export default async function ThankYouPage({ searchParams }: PageProps) {
  ...
  // Pull amount directly from Stripe — always available immediately after payment,
  // no race condition with the webhook writing to Supabase.
  ...
  if (sessionId) {
    try {
      ...
      // Non-fatal — page still loads, conversion just won't fire
    }
  }

  return (
    <>
      {conversionValue > 0 && sessionId && (
        <ConversionTracker value={conversionValue} transactionId={transactionId} />
      )}
